...
function toggleLanguage() {
  ...
  if (isArabic) {
    ...
    document.getElementById("desc").innerText = "أستمتع بتحويل الأفكار إلى تجارب عملية سهلة الاستخدام، مع الحرص على تطوير مهاراتي التقنية باستمرار, ";
    document.getElementById("desc").innerText = " هنا ستجدون مشاريع تعكس مسيرتي في مجال التكنولوجيا، وحل المشكلات، والتصميم الإبداعي. ";
