...
function toggleLanguage() {
  ...
  if (isArabic) {
    ...
    document.getElementById("desc").innerText = "خريجة تقنية معلومات، أركز بشكل متزايد على تطوير المواقع الإلكترونية وإنشاء المنتجات الرقمية أستمتع بتحويل الأفكار إلى تجارب عملية سهلة الاستخدام، مع الحرص على تطوير مهاراتي التقنية باستمرار,<br>  هنا ستجدون مشاريع تعكس مسيرتي في مجال التكنولوجيا، وحل المشكلات، والتصميم الإبداعي. ";
